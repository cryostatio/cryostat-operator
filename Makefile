...
OPENSHIFT_OAUTH_PROXY_VERSION ?= 4.22
...
DATASOURCE_VERSION ?= 4.2.0-snapshot
...
REPORTS_VERSION ?= 4.2.0-snapshot
...
DATABASE_VERSION ?= cryostat-v4.2
...
AGENT_INIT_VERSION ?= 0.7.0-snapshot
...
CONSOLE_PLUGIN_VERSION ?= 4.2.0-dev
