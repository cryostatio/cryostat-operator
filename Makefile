...
export OPERATOR_VERSION ?= 4.2.1-dev
...
export MAX_OPENSHIFT_VERSION ?= 4.21.0
...
DATASOURCE_VERSION ?= 4.2.1-snapshot
...
REPORTS_VERSION ?= 4.2.1-snapshot
...
AGENT_INIT_VERSION ?= 0.7.1-snapshot
...
CONSOLE_PLUGIN_VERSION ?= 4.2.1-dev
...
CUSTOM_SCORECARD_VERSION ?= 4.2.1-$(shell date -u '+%Y%m%d%H%M%S')
