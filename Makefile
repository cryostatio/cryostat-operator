...
DATASOURCE_VERSION ?= 2.3.2-snapshot
...
GRAFANA_VERSION ?= 2.3.2-snapshot
...
REPORTS_VERSION ?= 2.3.2-snapshot
...
CUSTOM_SCORECARD_VERSION ?= 2.3.2-$(shell date -u '+%Y%m%d%H%M%S')
