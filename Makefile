...
export OPERATOR_VERSION ?= 4.1.2-dev
...
OPENSHIFT_OAUTH_PROXY_VERSION ?= 4.20
...
DATASOURCE_VERSION ?= 4.1.2-snapshot
...
REPORTS_VERSION ?= 4.1.2-snapshot
...
AGENT_INIT_VERSION ?= 0.6.2-snapshot
...
CONSOLE_PLUGIN_VERSION ?= 4.1.2-dev
...
CUSTOM_SCORECARD_VERSION ?= 4.1.1-$(shell date -u '+%Y%m%d%H%M%S')
