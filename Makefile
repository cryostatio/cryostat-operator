...
export OPERATOR_VERSION ?= 4.0.4-dev
...
DATASOURCE_VERSION ?= 4.0.4-snapshot
...
REPORTS_VERSION ?= 4.0.4-snapshot
...
AGENT_INIT_VERSION ?= 0.5.4-snapshot
...
CONSOLE_PLUGIN_VERSION ?= 4.0.4-dev
...
CUSTOM_SCORECARD_VERSION ?= 4.0.4-$(shell date -u '+%Y%m%d%H%M%S')
