...
export OPERATOR_VERSION ?= 4.0.2-dev
...
DATASOURCE_VERSION ?= 4.0.2-snapshot
...
REPORTS_VERSION ?= 4.0.2-snapshot
...
AGENT_INIT_VERSION ?= 0.5.2-snapshot
...
CONSOLE_PLUGIN_VERSION ?= 4.0.2-dev
