...
export OPERATOR_VERSION ?= 4.1.1-dev
...
DATASOURCE_VERSION ?= 4.1.1-snapshot
...
REPORTS_VERSION ?= 4.1.1-snapshot
...
AGENT_INIT_VERSION ?= 0.6.1-snapshot
...
CONSOLE_PLUGIN_VERSION ?= 4.1.1-dev
