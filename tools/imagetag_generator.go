...
func main() {
	...
	file, err := os.Create("imagetag_generated.go")
	if err != nil {
		log.Fatal(err)
	}
	defer file.Close()

	err = fileTemplate.Execute(file, imageTags)
	if err != nil {
		log.Fatal(err)
	}
}
...
func getEnvVar(name string) string {
	...
	if !pres {
		log.Fatalf("Environment variable for image tag %s not defined", name)
	}
	return val
}

var fileTemplate = template.Must(template.New("").Parse(`// Code generated by imagetag_generator.go; DO NOT EDIT.
