...
func (in *AuthorizationOptions) DeepCopyInto(out *AuthorizationOptions) {
	*out = *in
	if in.OpenShiftSsoRoles != nil {
		in, out := &in.OpenShiftSsoRoles, &out.OpenShiftSsoRoles
		*out = new(OpenShiftSsoRoles)
		(*in).DeepCopyInto(*out)
	}
	if in.BasicAuth != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenShiftSsoRoles) DeepCopyInto(out *OpenShiftSsoRoles) {
	*out = *in
	if in.Disabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenShiftSsoRoles.
func (in *OpenShiftSsoRoles) DeepCopy() *OpenShiftSsoRoles {
	if in == nil {
		return nil
	}
	out := new(OpenShiftSsoRoles)
