...
func (in *AuthorizationOptions) DeepCopyInto(out *AuthorizationOptions) {
	*out = *in
	if in.BasicAuthSecretName != nil {
		in, out := &in.BasicAuthSecretName, &out.BasicAuthSecretName
		*out = new(string)
		**out = **in
	}
	if in.BasicAuthFilename != nil {
		in, out := &in.BasicAuthFilename, &out.BasicAuthFilename
		*out = new(string)
		**out = **in
	}
}
