...
func (in *AuthPropertiesConfigMap) DeepCopyInto(out *AuthPropertiesConfigMap) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthPropertiesConfigMap.
func (in *AuthPropertiesConfigMap) DeepCopy() *AuthPropertiesConfigMap {
	if in == nil {
		return nil
	}
...
func (in *CryostatSpec) DeepCopyInto(out *CryostatSpec) {
	*out = *in
	...
	out.AuthProperties = in.AuthProperties
}
