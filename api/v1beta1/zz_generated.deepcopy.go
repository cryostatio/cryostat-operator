...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiscoveryPortConfiguration) DeepCopyInto(out *DiscoveryPortConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiscoveryPortConfiguration.
func (in *DiscoveryPortConfiguration) DeepCopy() *DiscoveryPortConfiguration {
	if in == nil {
		return nil
	}
	out := new(DiscoveryPortConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TargetDiscoveryOptions) DeepCopyInto(out *TargetDiscoveryOptions) {
	*out = *in
	if in.DiscoveryPortConfig != nil {
		in, out := &in.DiscoveryPortConfig, &out.DiscoveryPortConfig
		*out = new(DiscoveryPortConfiguration)
		(*in).DeepCopyInto(*out)
	}
}
