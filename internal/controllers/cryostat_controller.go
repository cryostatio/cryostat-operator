...
func (r *CryostatReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	for _, cond := range deployment.Status.Conditions {
		if cond.Type == appsv1.DeploymentAvailable {
			err := r.updateCondition(ctx, instance, operatorv1beta1.ConditionTypeMainDeploymentAvailable,
				metav1.ConditionStatus(cond.Status), cond.Reason, cond.Message)
			if err != nil {
				return reconcile.Result{}, err
			}
		}
...
func (r *CryostatReconciler) reconcileReports(ctx context.Context, reqLogger logr.Logger, instance *operatorv1beta1.Cryostat,
	...
	if desired == 0 {
		...
		// Update reports deployment condition
		err := r.updateCondition(ctx, instance, operatorv1beta1.ConditionTypeReportsDeploymentAvailable,
			metav1.ConditionTrue, reasonReportsDisabled, "Reports will be generated by the main Cryostat deployment.")
		if err != nil {
			return reconcile.Result{}, err
		}
		return reconcile.Result{}, nil
