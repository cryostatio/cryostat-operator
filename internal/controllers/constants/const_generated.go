...
const OperatorVersion = "4.1.2-dev"
...
const DefaultCoreImageTag = "quay.io/cryostat/cryostat:4.1.2-snapshot"

// Default image tag for the JFR datasource image
const DefaultDatasourceImageTag = "quay.io/cryostat/jfr-datasource:4.1.2-snapshot"
...
// Default image tag for the Grafana dashboard image
const DefaultReportsImageTag = "quay.io/cryostat/cryostat-reports:4.1.2-snapshot"
...
const DefaultAgentInitImageTag = "quay.io/cryostat/cryostat-agent-init:0.6.2-snapshot"
