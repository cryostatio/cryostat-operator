...
const DefaultOpenShiftOAuthProxyImageTag = "quay.io/cryostat/openshift-oauth-proxy:4.0.2"

// Default image tag for the core application image
const DefaultCoreImageTag = "quay.io/cryostat/cryostat:4.0.2"

// Default image tag for the JFR datasource image
const DefaultDatasourceImageTag = "quay.io/cryostat/jfr-datasource:4.0.2"

// Default image tag for the Grafana dashboard image
const DefaultGrafanaImageTag = "quay.io/cryostat/cryostat-grafana-dashboard:4.0.2"

// Default image tag for the Grafana dashboard image
const DefaultReportsImageTag = "quay.io/cryostat/cryostat-reports:4.0.2"

// Default image tag for the Storage image
const DefaultStorageImageTag = "quay.io/cryostat/cryostat-storage:4.0.2"

// Default image tag for the Database image
const DefaultDatabaseImageTag = "quay.io/cryostat/cryostat-db:4.0.2"
...
const DefaultAgentInitImageTag = "quay.io/cryostat/cryostat-agent-init:0.5.2"
