	...
	return &appsv1.Deployment{
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels: map[string]string{
				...
				"cryostat.io/callback-port":           "123",
				"cryostat.io/container":               "other-container",
				"cryostat.io/read-only":               "false",
				"cryostat.io/java-options-var":        "somevar",
				"cryostat.io/harvester-template":      "all",
				"cryostat.io/harvester-exit-max-age":  "456s",
				"cryostat.io/harvester-exit-max-size": "789",
				"cryostat.io/smart-triggers":          "someConfigMap",
			},
