...
const agentInitImageEnv = "AGENT_INIT_IMG"
...
func main() {
	...
	consts := struct {
		...
		AgentInitImageTag:           getEnvVar(agentInitImageEnv),
	}
...
const DefaultAgentInitImageTag = "{{ .AgentInitImageTag }}"
`))
